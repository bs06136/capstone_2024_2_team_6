...
# CSV 파일 읽기
file_path = r"D:\캡스톤 디자인(1)\recorded_data_2024-10-13_13-07-50.csv"  # 파일 경로 수정
...
gamma_power = calculate_band_power(f_clean, fft_magnitude_clean, gamma_range)
...
gamma_ratio = (gamma_power / total_power) * 100
...
print(f"Gamma (30Hz 이상) 비율: {gamma_ratio:.2f}%")
